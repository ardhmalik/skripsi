...
<?php foreach ($data_edu as $edu) : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <small class="text-muted fst-italic">
                                    <?php if (date('Y-m-d', strtotime($edu['selesai'])) < date('Y-m-d', strtotime('today'))) : ?>
    ...
    <!-- Modal del Edukasi -->
    <div class="modal fade" id="delEdu-<?= $edu['id_edu'] ?>" tabindex="-1" aria-labelledby="formDelEdu" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title" id="formDelEdu">Delete Edukasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!-- End Modal Header -->
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <h5 class="text-center text-bold">
                            Anda yakin menghapus edukasi ini?
                        </h5>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                        ...
                        <!-- Form Aktifkan mitra -->
                        <form action="<?= site_url('del_edukasi') ?>" method="post">
                            <input type="hidden" name="id_edu" id="id_edu" value="<?= $edu['id_edu'] ?>">
                            <input type="hidden" name="judul" id="judul" value="<?= $edu['judul'] ?>">
                            <div class="d-flex bd-highlight">
                                <div class="p-2 bd-highlight">
                                    <button type="button" class="btn fw-bold btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
                                </div>
